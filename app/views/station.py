...
def station_ranking(request):
	...
	month_time = sorted(month_time, key=lambda e: e.__getitem__('AQI'))
	ret_data = {}
	ret_data["real_time"] = real_time
	ret_data["yesterday_time"] = yesterday_time
	ret_data["week_time"] = week_time
	ret_data["month_time"] = month_time
