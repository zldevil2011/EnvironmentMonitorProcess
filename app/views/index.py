...
def index_average(request):
	...
	for idx, data in enumerate(datas_list_today):
...
def index_voltage(request):
	...
	twelve_data = {}
	twelve_data_hour = []
	twelve_data_data = {"so2":[], "no2":[], "pm10":[], "co":[], "o3":[], "pm25":[], "voltage":[]}
	...
	try:
		...
		parameter = "PM10"
	return render(request, "app/device_voltage.html", {
		# "pre_alarm_time": pre_alarm_time,
		"twelve_data": twelve_data,
		"data_real_time": data_list_20,
		"device_list": device_list,
